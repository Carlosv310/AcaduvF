...
import 'followingpageyes_model.dart';
export 'followingpageyes_model.dart';

class FollowingpageyesWidget extends StatefulWidget {
  const FollowingpageyesWidget({
    Key? key,
    required this.users,
  }) : super(key: key);
  ...
  @override
  _FollowingpageyesWidgetState createState() => _FollowingpageyesWidgetState();
}

class _FollowingpageyesWidgetState extends State<FollowingpageyesWidget> {
  late FollowingpageyesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FollowingpageyesModel());
