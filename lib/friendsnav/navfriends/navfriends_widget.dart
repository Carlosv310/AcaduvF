...
import 'navfriends_model.dart';
export 'navfriends_model.dart';

class NavfriendsWidget extends StatefulWidget {
  const NavfriendsWidget({
    Key? key,
    this.following,
  }) : super(key: key);

  final UsersRecord? following;

  @override
  _NavfriendsWidgetState createState() => _NavfriendsWidgetState();
}

class _NavfriendsWidgetState extends State<NavfriendsWidget> {
  late NavfriendsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NavfriendsModel());
