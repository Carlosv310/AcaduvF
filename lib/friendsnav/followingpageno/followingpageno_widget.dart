...
import 'followingpageno_model.dart';
export 'followingpageno_model.dart';

class FollowingpagenoWidget extends StatefulWidget {
  const FollowingpagenoWidget({
    Key? key,
    required this.users,
  }) : super(key: key);
  ...
  @override
  _FollowingpagenoWidgetState createState() => _FollowingpagenoWidgetState();
}

class _FollowingpagenoWidgetState extends State<FollowingpagenoWidget> {
  late FollowingpagenoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FollowingpagenoModel());
